function GCal() {
    window.open("calendar.html", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=400,height=400, left=200%, top=200%");
  }
  function GMap() {
    window.open("map.html", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=400,height=400, left=200%, top=200%");
  }
  function privacy() {
